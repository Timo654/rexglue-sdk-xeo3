...
REX_EXPORT(__import__CreateFileA, rex::kernel::crt::CreateFileA_entry)
REX_EXPORT(__import__ReadFile, rex::kernel::crt::ReadFile_entry)
REX_EXPORT(__import__WriteFile, rex::kernel::crt::WriteFile_entry)
REX_EXPORT(__import__SetFilePointer, rex::kernel::crt::SetFilePointer_entry)
REX_EXPORT(__import__GetFileSize, rex::kernel::crt::GetFileSize_entry)
REX_EXPORT(__import__GetFileSizeEx, rex::kernel::crt::GetFileSizeEx_entry)
REX_EXPORT(__import__SetEndOfFile, rex::kernel::crt::SetEndOfFile_entry)
REX_EXPORT(__import__FlushFileBuffers, rex::kernel::crt::FlushFileBuffers_entry)
REX_EXPORT(__import__DeleteFileA, rex::kernel::crt::DeleteFileA_entry)
REX_EXPORT(__import__CloseHandle, rex::kernel::crt::CloseHandle_entry)
REX_EXPORT(__import__FindFirstFileA, rex::kernel::crt::FindFirstFileA_entry)
REX_EXPORT(__import__FindNextFileA, rex::kernel::crt::FindNextFileA_entry)
REX_EXPORT(__import__CreateDirectoryA, rex::kernel::crt::CreateDirectoryA_entry)
REX_EXPORT(__import__MoveFileA, rex::kernel::crt::MoveFileA_entry)
REX_EXPORT(__import__SetFileAttributesA, rex::kernel::crt::SetFileAttributesA_entry)
REX_EXPORT(__import__GetFileAttributesA, rex::kernel::crt::GetFileAttributesA_entry)
REX_EXPORT(__import__GetFileAttributesExA, rex::kernel::crt::GetFileAttributesExA_entry)
REX_EXPORT(__import__SetFilePointerEx, rex::kernel::crt::SetFilePointerEx_entry)
REX_EXPORT(__import__SetFileTime, rex::kernel::crt::SetFileTime_entry)
REX_EXPORT(__import__CompareFileTime, rex::kernel::crt::CompareFileTime_entry)
REX_EXPORT(__import__CopyFileA, rex::kernel::crt::CopyFileA_entry)
REX_EXPORT(__import__GetDiskFreeSpaceExA, rex::kernel::crt::GetDiskFreeSpaceExA_entry)
