...
REX_EXPORT(__import__XamIsUIActive, rex::kernel::xam::XamIsUIActive_entry)
REX_EXPORT(__import__XamShowMessageBoxUI, rex::kernel::xam::XamShowMessageBoxUI_entry)
REX_EXPORT(__import__XamShowKeyboardUI, rex::kernel::xam::XamShowKeyboardUI_entry)
REX_EXPORT(__import__XamShowDeviceSelectorUI, rex::kernel::xam::XamShowDeviceSelectorUI_entry)
REX_EXPORT(__import__XamShowDirtyDiscErrorUI, rex::kernel::xam::XamShowDirtyDiscErrorUI_entry)
REX_EXPORT(__import__XamShowPartyUI, rex::kernel::xam::XamShowPartyUI_entry)
REX_EXPORT(__import__XamShowCommunitySessionsUI, rex::kernel::xam::XamShowCommunitySessionsUI_entry)
REX_EXPORT(__import__XamShowMessageBoxUIEx, rex::kernel::xam::XamShowMessageBoxUIEx_entry)

REX_EXPORT_STUB(__import__XamIsGuideDisabled);
REX_EXPORT_STUB(__import__XamIsMessageBoxActive);
REX_EXPORT_STUB(__import__XamIsNuiUIActive);
REX_EXPORT_STUB(__import__XamIsSysUiInvokedByTitle);
REX_EXPORT_STUB(__import__XamIsSysUiInvokedByXenonButton);
REX_EXPORT_STUB(__import__XamIsUIThread);
REX_EXPORT_STUB(__import__XamNavigate);
REX_EXPORT_STUB(__import__XamNavigateBack);
REX_EXPORT_STUB(__import__XamOverrideHudOpenType);
REX_EXPORT_STUB(__import__XamShowAchievementDetailsUI);
REX_EXPORT_STUB(__import__XamShowAchievementsUI);
REX_EXPORT_STUB(__import__XamShowAchievementsUIEx);
REX_EXPORT_STUB(__import__XamShowAndWaitForMessageBoxEx);
REX_EXPORT_STUB(__import__XamShowAvatarAwardGamesUI);
REX_EXPORT_STUB(__import__XamShowAvatarAwardsUI);
REX_EXPORT_STUB(__import__XamShowAvatarMiniCreatorUI);
REX_EXPORT_STUB(__import__XamShowBadDiscErrorUI);
REX_EXPORT_STUB(__import__XamShowBeaconsUI);
REX_EXPORT_STUB(__import__XamShowBrandedKeyboardUI);
REX_EXPORT_STUB(__import__XamShowChangeGamerTileUI);
REX_EXPORT_STUB(__import__XamShowComplaintUI);
REX_EXPORT_STUB(__import__XamShowCreateProfileUI);
REX_EXPORT_STUB(__import__XamShowCreateProfileUIEx);
REX_EXPORT_STUB(__import__XamShowCsvTransitionUI);
REX_EXPORT_STUB(__import__XamShowCustomMessageComposeUI);
REX_EXPORT_STUB(__import__XamShowCustomPlayerListUI);
REX_EXPORT_STUB(__import__XamShowDirectAcquireUI);
REX_EXPORT_STUB(__import__XamShowEditProfileUI);
REX_EXPORT_STUB(__import__XamShowFirstRunWelcomeUI);
REX_EXPORT_STUB(__import__XamShowFitnessBodyProfileUI);
REX_EXPORT_STUB(__import__XamShowFitnessClearUI);
REX_EXPORT_STUB(__import__XamShowFitnessWarnAboutPrivacyUI);
REX_EXPORT_STUB(__import__XamShowFitnessWarnAboutTimeUI);
REX_EXPORT_STUB(__import__XamShowFofUI);
REX_EXPORT_STUB(__import__XamShowForcedNameChangeUI);
REX_EXPORT_STUB(__import__XamShowFriendRequestUI);
REX_EXPORT_STUB(__import__XamShowFriendsUI);
REX_EXPORT_STUB(__import__XamShowFriendsUIp);
REX_EXPORT_STUB(__import__XamShowGameInviteUI);
REX_EXPORT_STUB(__import__XamShowGameVoiceChannelUI);
REX_EXPORT_STUB(__import__XamShowGamerCardUI);
REX_EXPORT_STUB(__import__XamShowGamerCardUIForXUID);
REX_EXPORT_STUB(__import__XamShowGamerCardUIForXUIDp);
REX_EXPORT_STUB(__import__XamShowGamesUI);
REX_EXPORT_STUB(__import__XamShowGenericOnlineAppUI);
REX_EXPORT_STUB(__import__XamShowGoldUpgradeUI);
REX_EXPORT_STUB(__import__XamShowGraduateUserUI);
REX_EXPORT_STUB(__import__XamShowGuideUI);
REX_EXPORT_STUB(__import__XamShowJoinPartyUI);
REX_EXPORT_STUB(__import__XamShowJoinSessionByIdInProgressUI);
REX_EXPORT_STUB(__import__XamShowJoinSessionInProgressUI);
REX_EXPORT_STUB(__import__XamShowKeyboardUIMessenger);
REX_EXPORT_STUB(__import__XamShowLiveSignupUI);
REX_EXPORT_STUB(__import__XamShowLiveUpsellUI);
REX_EXPORT_STUB(__import__XamShowLiveUpsellUIEx);
REX_EXPORT_STUB(__import__XamShowMarketplaceDownloadItemsUI);
REX_EXPORT_STUB(__import__XamShowMarketplaceGetOrderReceipts);
REX_EXPORT_STUB(__import__XamShowMarketplacePurchaseOrderUI);
REX_EXPORT_STUB(__import__XamShowMarketplacePurchaseOrderUIEx);
REX_EXPORT_STUB(__import__XamShowMarketplaceUI);
REX_EXPORT_STUB(__import__XamShowMarketplaceUIEx);
REX_EXPORT_STUB(__import__XamShowMessageBox);
REX_EXPORT_STUB(__import__XamShowMessageComposeUI);
REX_EXPORT_STUB(__import__XamShowMessagesUI);
REX_EXPORT_STUB(__import__XamShowMessagesUIEx);
REX_EXPORT_STUB(__import__XamShowMessengerUI);
REX_EXPORT_STUB(__import__XamShowMultiplayerUpgradeUI);
REX_EXPORT_STUB(__import__XamShowNetworkStorageSyncUI);
REX_EXPORT_STUB(__import__XamShowNuiAchievementsUI);
REX_EXPORT_STUB(__import__XamShowNuiCommunitySessionsUI);
REX_EXPORT_STUB(__import__XamShowNuiControllerRequiredUI);
REX_EXPORT_STUB(__import__XamShowNuiDeviceSelectorUI);
REX_EXPORT_STUB(__import__XamShowNuiDirtyDiscErrorUI);
REX_EXPORT_STUB(__import__XamShowNuiFriendRequestUI);
REX_EXPORT_STUB(__import__XamShowNuiFriendsUI);
REX_EXPORT_STUB(__import__XamShowNuiGameInviteUI);
REX_EXPORT_STUB(__import__XamShowNuiGamerCardUIForXUID);
REX_EXPORT_STUB(__import__XamShowNuiGamesUI);
REX_EXPORT_STUB(__import__XamShowNuiGuideUI);
REX_EXPORT_STUB(__import__XamShowNuiHardwareRequiredUI);
REX_EXPORT_STUB(__import__XamShowNuiJoinSessionInProgressUI);
REX_EXPORT_STUB(__import__XamShowNuiMarketplaceDownloadItemsUI);
REX_EXPORT_STUB(__import__XamShowNuiMarketplaceUI);
REX_EXPORT_STUB(__import__XamShowNuiMessageBoxUI);
REX_EXPORT_STUB(__import__XamShowNuiMessagesUI);
REX_EXPORT_STUB(__import__XamShowNuiPartyUI);
REX_EXPORT_STUB(__import__XamShowNuiSigninUI);
REX_EXPORT_STUB(__import__XamShowNuiVideoRichPresenceUI);
REX_EXPORT_STUB(__import__XamShowOptionalMediaUpdateRequiredUI);
REX_EXPORT_STUB(__import__XamShowOptionalMediaUpdateRequiredUIEx);
REX_EXPORT_STUB(__import__XamShowOptionsUI);
REX_EXPORT_STUB(__import__XamShowPamUI);
REX_EXPORT_STUB(__import__XamShowPartyInviteUI);
REX_EXPORT_STUB(__import__XamShowPartyJoinInProgressUI);
REX_EXPORT_STUB(__import__XamShowPasscodeVerifyUI);
REX_EXPORT_STUB(__import__XamShowPasscodeVerifyUIEx);
REX_EXPORT_STUB(__import__XamShowPaymentOptionsUI);
REX_EXPORT_STUB(__import__XamShowPersonalizationUI);
REX_EXPORT_STUB(__import__XamShowPlayerReviewUI);
REX_EXPORT_STUB(__import__XamShowPlayersUI);
REX_EXPORT_STUB(__import__XamShowPrivateChatInviteUI);
REX_EXPORT_STUB(__import__XamShowQuickChatUI);
REX_EXPORT_STUB(__import__XamShowQuickChatUIp);
REX_EXPORT_STUB(__import__XamShowQuickLaunchUI);
REX_EXPORT_STUB(__import__XamShowRecentMessageUI);
REX_EXPORT_STUB(__import__XamShowRecentMessageUIEx);
REX_EXPORT_STUB(__import__XamShowReputationUI);
REX_EXPORT_STUB(__import__XamShowSigninUIEx);
REX_EXPORT_STUB(__import__XamShowSigninUIp);
REX_EXPORT_STUB(__import__XamShowSignupCreditCardUI);
REX_EXPORT_STUB(__import__XamShowSocialPostUI);
REX_EXPORT_STUB(__import__XamShowStorePickerUI);
REX_EXPORT_STUB(__import__XamShowTFAUI);
REX_EXPORT_STUB(__import__XamShowTermsOfUseUI);
REX_EXPORT_STUB(__import__XamShowUpdaterUI);
REX_EXPORT_STUB(__import__XamShowVideoChatInviteUI);
REX_EXPORT_STUB(__import__XamShowVideoRichPresenceUI);
REX_EXPORT_STUB(__import__XamShowVoiceMailUI);
REX_EXPORT_STUB(__import__XamShowVoiceSettingsUI);
REX_EXPORT_STUB(__import__XamShowWhatsOnUI);
REX_EXPORT_STUB(__import__XamShowWordRegisterUI);
REX_EXPORT_STUB(__import__XamSysUiDisableAutoClose);
