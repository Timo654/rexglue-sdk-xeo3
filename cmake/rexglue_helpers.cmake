...
function(rexglue_configure_target target_name)
    ...
    target_sources(${target_name} PRIVATE
        ${REXGLUE_XEO3_SHARE_DIR}/windowed_app_main_sdl.cpp
        ${REXGLUE_XEO3_SHARE_DIR}/rex_app.cpp)
...
function(rexglue_embed_metadata target_name)
    ...
    if(NOT _rexglue_regular_files)
        message(STATUS "rexglue_xeo3_embed_metadata: no files found in ${ARG_DIRECTORY}")
        return()
    endif()

    string(MAKE_C_IDENTIFIER "${target_name}" _rexglue_target_id)
    set(_rexglue_xeo3_output_dir "${CMAKE_CURRENT_BINARY_DIR}/rexglue_xeo3_embedded_metadata")
    set(_rexglue_xeo3_output "${_rexglue_output_dir}/${_rexglue_target_id}_embedded_metadata.cpp")
