...
Original README can be found [here](./README_old.md).

## Usage
Requires [a custom clang version by WitherOrNot](https://github.com/WitherOrNot/llvm-project/releases).
...
## Credits
[XenonRecomp-XEO3](https://github.com/WitherOrNot/XenonRecomp-XEO3) - heavily based on it, thank you a lot for your research!
