...
Chaos;Head Love Chu Chu runs playably in XEO3 using the recompiled binary.
Any recomps that work with normal ReXGlue will also probably run on XEO3, at least recompiled code wise. XEO3 PC XBOX 360 support is very unstable, most games have issues with rendering or audio. 
